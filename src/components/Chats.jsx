...
const Chats = ({ chatId }) => {
  ...
  const sendMessage = async (e) => {
    ...
    console.log("sending a new msg =>", messageContent);
  };
          ...
          ([date, messagesForDate]) => (
            <div key={date}>
              ...
              {messagesForDate.map((message) => (
                <div
                  key={message._id}
                  className={`flex m-2 my-0.5 px-1 py-0.5 ${
                ...
                >
                  ...
                  >
                    <p className="max-w-96 inline-block p-2 pr-1 text-wrap break-words font-medium text-sm">
                      {message.text}
                    </p>
...
Chats.propTypes = {
  chatId: PropTypes.node.isRequired,
};
